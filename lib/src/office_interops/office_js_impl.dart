...
abstract class RangeFormatJsImpl
  ...
  external set autoIndent(bool value);

  /// Collection of border objects that apply to the overall range.
  external Excel.RangeBorderCollectionJsImpl get borders;

  /// Specifies the width of all columns within the range. If the column widths are not uniform, null will be returned.
  external double get columnWidth;
  external set columnWidth(double value);

  /// Returns the fill object defined on the overall range.
  external Excel.RangeFillJsImpl get fill;

  /// Returns the font object defined on the overall range.
  external Excel.RangeFontJsImpl get font;

  /// Represents the horizontal alignment for the specified object.
  external Excel.HorizontalAlignment get horizontalAlignment;
  external set horizontalAlignment(Excel.HorizontalAlignment value);

  /// An integer from 0 to 250 that indicates the indent level.
  external int get indentLevel;
  external set indentLevel(int value);

  /// Returns the format protection object for a range.
  external Excel.FormatProtectionJsImpl get protection;

  /// The reading order for the range.
  external Excel.ReadingOrder get readingOrder;
  external set readingOrder(Excel.ReadingOrder value);

  /// The height of all rows in the range. If the row heights are not uniform, null will be returned.
  external double get rowHeight;
  external set rowHeight(double value);

  /// Specifies if text automatically shrinks to fit in the available column width.
  external bool get shrinkToFit;
  external set shrinkToFit(bool value);

  /// The text orientation of all the cells within the range.
  external int get textOrientation;
  external set textOrientation(int value);

  /// Determines if the row height of the Range object equals the standard height of the sheet.
  external bool get useStandardHeight;
  external set useStandardHeight(bool value);

  /// Specifies if the column width of the Range object equals the standard width of the sheet.
  external bool get useStandardWidth;
  external set useStandardWidth(bool value);

  /// Represents the vertical alignment for the specified object.
  external Excel.VerticalAlignment get verticalAlignment;
  external set verticalAlignment(Excel.VerticalAlignment value);

  external void adjustIndent(int amount);

  external void autofitColumns();

  external void autofitRows();

  external RangeFormatJsImpl load(Excel.Interfaces.RangeFormatLoadOptions options);

  external RangeFormatJsImpl loadProperties(List<String> propertyNames);

  external RangeFormatJsImpl loadPropertiesAndPaths(
      Excel.Interfaces.RangeFormatLoadOptions options);

  external void setProperties(
      Excel.Interfaces.RangeFormatUpdateData properties,
      OfficeExtension.UpdateOptions options);

  external void setFromExisting(RangeFormatJsImpl properties);
  
  // external Excel.Interfaces.RangeFormat toJson();
